    ...
    Foundation.libs.tooltip = {
        ...
        events: function () {
            ...
            if (Modernizr.touch) {
                ...
                S(document)
                  .off('.tooltip')
                  .on('focusin.fndtn.tooltip focusout.fndtn.tooltip mouseenter.fndtn.tooltip mouseleave.fndtn.tooltip',
                    '[' + this.attr_name() + ']', function (e) {
                        var $this = S(this);

                        if (/focusin|enter|over/i.test(e.type)) {
                            this.timer = setTimeout(function () {
                                var tip = self.showOrCreateTip($this);
                            }.bind(this), self.settings.hover_delay);
                        } else if (e.type === 'focusout' || e.type === 'mouseout' || e.type === 'mouseleave') {
...
; (function ($, window, document, undefined) {
    ...
    Foundation.libs.tooltip = {
        ...
        settings: {
            ...
            show_on: 'all',
            tip_template: function (selector, content) {
                return '<span data-selector="' + selector + '" id="' + selector + '" aria-hidden="true" class="'
                  + Foundation.libs.tooltip.settings.tooltip_class.substring(1)
        ...
        events: function (instance) {
            ...
            $(this.scope)
              .off('.tooltip')
              .on('mouseenter.fndtn.tooltip mouseleave.fndtn.tooltip touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip focus.fndtn.tooltip focusout.fndtn.tooltiip',
                '[' + this.attr_name() + ']', function (e) {
                    var $this = S(this),
          ...
          topbar
            ...
            .css('height', function () {
                ...
                if (!$(this).hasClass("expanded")) {
                    var logo_outer_wrapper_height = topbar.find("img").height();
                    var min_height = 38;

                    if (logo_outer_wrapper_height < min_height) {
                        logo_outer_wrapper_height = min_height;
                    }
                    nav_height = logo_outer_wrapper_height + 30;
                } else {
                    nav_height = '';
                }
                return nav_height;
      ...
      S(this.scope)
        ...
        .on('click.fndtn.topbar', '[' + this.attr_name() + '] .has-dropdown>a', function (e) {
          if (self.breakpoint()) {
            ...
            /*
        }).on('focus.fndtn.topbar', '[' + this.attr_name() + '] .toggle-topbar', function (e) {
          e.preventDefault();
          self.toggle(this);
        })
        .on('focus.fndtn.topbar', '[' + this.attr_name() + '] li.has-dropdown', function (e) {
          var li = S(this),
              target = S(e.target),
              topbar = li.closest('[' + self.attr_name() + ']'),
              settings = topbar.data(self.attr_name(true) + '-init');
        ...
        .on('focus.fndtn.topbar', '[' + this.attr_name() + '] .has-dropdown>a', function (e) {
          if (self.breakpoint()) {
